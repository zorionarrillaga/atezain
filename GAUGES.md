...
every line measured on tree `ce104d2715db` at `2e41ce1+` (`tests/gauge_record.py tree` prints the
...
| `make test` with `ATEZAIN_TEST_DSN` | 509 passed, 1 skipped (2026-09-05, tree ce104d2715db at 2e41ce1+) |
