...
| Release engineering | `GAUGES.md`; pinned dependency advisory report; Linux runtime dependency resolution | Docker execution and hosted CI remain SKIPPED on this machine; deployment and independent security assessment require authorization/environment |

A green engineering gate permits a reviewable candidate. It does not substitute for the customer
acceptance column. No deployment, purchase, legal commitment or production-data connection was made.
