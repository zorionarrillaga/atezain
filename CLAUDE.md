...
make test       # 142 + 82 skipped (09-02); ATEZAIN_TEST_DSN=… make test → 223 + 1 skipped, both stores end to end
...
make serve                         # the web face locally: SQLite + stub model, no key
