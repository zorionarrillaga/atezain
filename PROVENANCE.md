...
The size of that account is deliberately not stated, here or anywhere else in this repository: what
a rule cost is evidence, and what an account held is not, so the second is withheld and the first
is not. The remaining figures are the costs of the incidents themselves.
